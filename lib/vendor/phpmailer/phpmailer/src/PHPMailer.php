...
class PHPMailer
{
     ...
     * It's a good idea to use this if you are sending multiple messages as it reduces overheader.
    ...
    public function encodeheader($str, $position = 'text')
    {
        ...
        $overheader = 8 + strlen($charset);

        if ('mail' === $this->Mailer) {
            $maxlen = static::MAIL_MAX_LINE_LENGTH - $overheader;
        } else {
            $maxlen = static::MAX_LINE_LENGTH - $overheader;
        }
    ...
    public function html2text($html, $advanced = false)
    {
        ...
        return html_entity_decode(
            trim(strip_tags(preg_replace('/<(header|title|style|script)[^>]*>.*?<\/\\1>/si', '', $html))),
            ENT_QUOTES,
            $this->CharSet
        );
    }
    ...
    public function DKIM_headerC($signheader)
    {
        ...
        foreach ($lines as $key => $line) {
            ...
            $lines[$key] = trim($header, " \t") . ':' . trim($value, " \t");
        }
