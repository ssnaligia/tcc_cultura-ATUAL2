...
<div id="header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a href="<?php echo (isset($_SESSION['logado']) && $_SESSION['logado'] == 1) ? 'indexUsuario.php' : 'index.php'; ?>"><img src="../assets/logo.svg" class="navbar-brand img-fluid" height="200" width="200" /></a>
